...
(@(& 'C:/Users/[username]/AppData/Local/Programs/oh-my-posh/bin/oh-my-posh.exe' init pwsh --config='C:\Users\[username]\AppData\Local\Programs\oh-my-posh\themes\powerlevel10k_lean.omp.json' --print) -join "`n") | Invoke-Expression
Import-Module Terminal-Icons
